...
def hi_vae_train_epoch(vae, device, dataloader, optimizer):
    ...
    for data in dataloader: 
        ...
        temp_mask = mask.squeeze(1).flatten(1,2)
...
class GPVariationalAutoencoder(nn.Module):
    def __init__(self, latent_dims,kernel_size,stride,kernel="cauchy",time_length = 8, sigma=1., length_scale=1.0, kernel_scales=1):
